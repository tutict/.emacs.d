...
function _validateSingle() {
  _validateSingle = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(document) {
    ...
    }, _callee9, null, [[8, 16], [22, 33, 36, 39]]);
  }));
  return _validateSingle.apply(this, arguments);
}
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            eslint_1.ESLint.ErrorHandlers.clearNoConfigRepoerted();
...
messageQueue.registerRequest(node_1.CodeActionRequest.type, /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(params) {
    var result, uri, textDocument, createCodeAction, createDisableLineTextEdit, createDisableSameLineTextEdit, createDisableFileTextEdit, getLastEdit, settings, problems, only, isSource, isSourceFixAll, textDocumentIdentifer, edits, fixes, documentVersion, allFixableRuleIds, kind, _iterator4, _step4, _loop, sameProblems, _iterator5, _step5, editInfo, same;
        ...
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            createDisableSameLineTextEdit = function _createDisableSameLin(textDocument, editInfo) {
              ...
              var matched = currentLine && new RegExp("".concat(languageDefaults_1.default.getLineComment(textDocument.languageId), " eslint-disable-line")).exec(currentLine);
              var disableRuleContent = matched && matched.length ? ", ".concat(editInfo.ruleId) : " ".concat(languageDefaults_1.default.getLineComment(textDocument.languageId), " eslint-disable-line ").concat(editInfo.ruleId);
            ...
            createDisableLineTextEdit = function _createDisableLineTex(textDocument, editInfo, indentationText) {
              ...
              if (editInfo.line - 1 > 0) {
                ...
                var matched = prevLine && prevLine.match(new RegExp("".concat(languageDefaults_1.default.getLineComment(textDocument.languageId), " eslint-disable-next-line")));
              ...
              return node_1.TextEdit.insert(node_1.Position.create(editInfo.line - 1, 0), "".concat(indentationText).concat(languageDefaults_1.default.getLineComment(textDocument.languageId), " eslint-disable-next-line ").concat(editInfo.ruleId).concat(os_1.EOL));
            };
